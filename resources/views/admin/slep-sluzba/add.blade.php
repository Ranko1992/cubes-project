...
<h1>Add new trailor</h1>
<hr>			

<div class="card mb-3">
    <div class="card-header">
        <i class="fa fa-table"></i> Add Trailor
    </div>
    <div class="card-body">
        ...
        <form id="row-form" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <input value="{{old('title')}}" name="title" placeholder="Enter Model" aria-describedby="titleHelpBlock" required="required" class="form-control here" type="text"> 
                    @if($errors->has('title'))
