...
<div class="card mb-3">
    <div class="card-header">
        <i class="fa fa-table"></i> Edit Car {{$car->model}}
    </div>
    <div class="card-body">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <input value="{{old('title', $car->title)}}" name="title" placeholder="Enter Title" aria-describedby="titleHelpBlock" required="required" class="form-control here" type="text"> 
                    @if($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <input value="{{old('model', $car->model)}}" name="model" placeholder="Enter Model" aria-describedby="titleHelpBlock" required="required" class="form-control here" type="text"> 
                    @if($errors->has('model'))
                    <div class="form-errors text-danger">
                ...
                <div class="form-group">
                    ...
                    <input value="{{old('production_year', $car->production_year)}}" name="production_year" placeholder="Enter production year" aria-describedby="titleHelpBlock" required="required" class="form-control here" type="text"> 
                ...
                <div class="form-group">
                    ...
                    <input value="{{old('miles',$car->miles)}}" name="miles" placeholder="Enter car's miles" aria-describedby="titleHelpBlock" required="required" class="form-control here" type="text"> 
                    @if($errors->has('miles'))
                    <div class="form-errors text-danger">
                ...
                <div class="form-group">
                    ...
                    <input value="{{old('power', $car->power)}}" name="power" placeholder="Enter cars's power" class="form-control here" type="text"> 
                    @if($errors->has('power'))
                    <div class="form-errors text-danger">
                ...
                <div class="form-group">
                    <label>Gorivo</label> 
                    <input value="{{old('fuel', $car->fuel)}}" name="fuel" placeholder="Enter car's fuel" class="form-control here" type="text"> 
                    @if($errors->has('fuel'))
                    <div class="form-errors text-danger">
            ...
            <div class="row">  
                ...
                <fieldset class="col-lg-2">
                    <legend>Slika 6</legend>
                        ...
                        <img 
                            class="img-fluid img-thumbnail" 
                            src="{{\Storage::disk('public')->url('/cars/' . $car->photo_filename_6)}}" 
                            alt="placeholder">
                        @else
                        <img class="img-fluid img-thumbnail" src="http://via.placeholder.com/640x480" alt="placeholder">
                        @endif
            ...
            <div class="form-group">
                <label>Opis</label> 
                <textarea name="description" placeholder="Enter Description" class="form-control" rows="12">{{old('description', $car->description)}}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="specification" placeholder="Enter Specification" class="form-control" rows="12">{{old('specification',$car->specification)}}</textarea>
            ...
            <div class="form-group">
                <label>Price</label> 
                <input value="{{old('price',$car->price)}}" name="price" placeholder="Enter Price" class="form-control here" type="text"> 
                @if($errors->has('price'))
                <div class="form-errors text-danger">
